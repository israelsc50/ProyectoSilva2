<div class="row">
            ...
            <div class="col-md-8">
                ...
                <hr>
                <img class="img-responsive" src="http://www.jamardawson.com/wp-content/uploads/2012/02/amazing-3d-art-earth-hd-wallpaper-2560x1440-900x300.jpg" alt="">
                <hr>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <ul class="list-unstyled">
                            	<?php foreach ($publicaciones as $publicacion): ?>
                                <li><a href="#"><?php echo $publicacion['Publicacion']['categoria']; ?></a>
                                </li>
